...
from flows_current import (
    send_details_by_coordinates as run_send_details_by_coordinates,
    start_current_weather_flow as run_start_current_weather_flow,
    start_details_flow as run_start_details_flow,
)
...
def start_current_weather_flow(message: types.Message, *, ctx, session_store) -> None:
    ...
    run_start_current_weather_flow(message, ctx=ctx, session_store=session_store)
...
def start_details_flow(message: types.Message, *, ctx, session_store) -> None:
    ...
    run_start_details_flow(message, ctx=ctx, session_store=session_store)
...
def send_details_by_coordinates(
    ...
    *,
    ...
    return run_send_details_by_coordinates(
        message,
        user_id,
        lat,
        lon,
